...
def train(config, epoch_from=0):
    ...
    n_epoch = config['train']['iterations_T'] // iterations_per_epoch + 1
    ...
    save_path_Opt = save_path_G[:-4] + '_Adam.pth'
    lr_scheduler = optim.lr_scheduler.StepLR(G_optimizer, 25000, 0.5)
